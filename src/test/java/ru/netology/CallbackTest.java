...
class CallbackTest {
    ...
    void shouldSearchByCssSelector() {
        ...
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("не знаю");
    ...
    void shouldNotSendWithLettersInsteadOfNumbers() {
        driver.get("http://localhost:9999");
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Сидоров Вова");
